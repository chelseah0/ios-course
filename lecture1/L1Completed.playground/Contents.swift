...
let netid = "mjs698" // this is immutable, once I assign a value to it, it can't be changed
var currentYear = 2020 // this can be changed!

// Let's try modifying them!
// netid = "yws3" (Can't do this, lets are constants and are immutable)
currentYear = 2021 // Since we used the var keyword to create this, the var is mutable
//: ### Type Annotations
...
var courseInstructors = ["Omar", "Yana"]
print(courseInstructors)
courseInstructors[0] = "Lucy"
courseInstructors[1] = "Mathew"
print(courseInstructors)

// What if we go out of range?
// courseInstructors[2] = "Mathew" // Index out of range again!

// If you're trying to add to the end, use append!
courseInstructors.append("Somebody")
print(courseInstructors)
//: ### Dictionaries
